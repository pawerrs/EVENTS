...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ReactiveUI.AutoSuspendHelper+ObservableLifecycle, ReactiveUI, Version=7.4.0.0, Culture=neutral, PublicKeyToken=null", AutoSuspendHelper_ObservableLifecycle.class, __md_methods);
	}


	public AutoSuspendHelper_ObservableLifecycle ()
	{
		super ();
		if (getClass () == AutoSuspendHelper_ObservableLifecycle.class)
			mono.android.TypeManager.Activate ("ReactiveUI.AutoSuspendHelper+ObservableLifecycle, ReactiveUI, Version=7.4.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
